...
Step 5: Project could be executed by using user interface such as chrome post man by selecting the post option(https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop?hl=en) 
		Provid the resource link http://localhost:8080/checkout-counter/webapi/resource/itemizedBill and put the below json content in the request body.
